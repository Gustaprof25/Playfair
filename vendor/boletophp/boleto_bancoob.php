...
$calculoDv = 0;
	for($num=0;$num<=strlen($sequencia);$num++)
	{
		...
		$calculoDv = $calculoDv + (settype($seq, 'integer') * $constante);
...
$dadosboleto["numero_documento"] = $titulo;	// Num do pedido ou do documento
...
$dadosboleto["demonstrativo1"] = "Valor da taxa de juros ao mês de 1% + multa por atraso de 2%. Não receber após 30 dias da data de vencimento";
...
// SEUS DADOS
$dadosboleto["identificacao"] = "Boleto Unimed Palmas";
$dadosboleto["cpf_cnpj"] = "37.313.475/0001-48";
$dadosboleto["endereco"] = "";
$dadosboleto["cidade_uf"] = "PALMAS / TO";
$dadosboleto["cedente"] = "UNIMED PALMAS COOPERATIVA MEDICA";

// NÃO ALTERAR!
include("include/funcoes_bancoob.php");
include("include/layout_bancoob_unimed.php");
