...
#instr_header {
	background: url("<?php echo base_url('public/img/boleto'); ?>"/logo_empresa.png) no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
<div id="container">
    ...
    <br/>
		<div class="barcode">
            <p><input style="width: 300px; background-color: #ebebeb; border: none" type="text" value="<?php echo $dadosboleto["codigo_barras"]; ?>" id="linha_digitavel" name="linha_digitavel" readonly></p>
